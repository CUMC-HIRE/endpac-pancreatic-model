...
age_layers_1y_nod = np.arange(37,53,1)
...
ages_to_smooth = np.arange(50,63,1) if risk == "nod" else [22.5,27.5,32.5,37.5,42.5,47.5,52.5,57.5,62.5,67.5,72.5,77.5,82.5]
...
acm_rates = acm_1y[:65] if param_interval == 1 else acm_5y
...
seer_inc_nod_full = pd.read_csv("../data/seer_incidence_nod_full.csv")  # NOTE: Ages 20-62
seer_inc_nod_only = pd.read_csv("../data/seer_incidence_nod.csv")  # NOTE: Ages 57-62 only
seer_inc = seer_inc_nod_full
